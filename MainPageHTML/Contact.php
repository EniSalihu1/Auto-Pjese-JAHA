            ...
            <h2>Numri i Telefonit</h2>
             ...
             <h2>LOKACIONI</h2>
              ...
              <div class="right-section">
                <h2>CONTACT US</h2>
                 <form>
                     <input type="text" placeholder="Shkruaj emrin tende" required>
                      <input type="email"placeholder="Shkruani nje email valide" required>
                       <textarea placeholder="Mesazhi juaj">
                       </textarea>
                       <button type="submit" class="btn"><a href="./Main.html">SUBMIT </a></button>
                     </form>
                     </div>
                    </div>
