...
<head>
    ...
    <link rel="stylesheet" href="../MainPageCss/ForgotPassword.css">
    ...
    <div class="wrapper">
       <form action="">
        <div id="Hyrje">
            ...
            <b><h1>Forgot your password?</h1></b>

            <div>Enter your email and we'll sent you a link to reset your password</div>
        </div>
